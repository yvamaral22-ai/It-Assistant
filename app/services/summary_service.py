...
def build_summary(item: SupportSession) -> str:
    lines = [
        ...
        f"Patrimônio: {item.asset_tag or 'Não informado'}",
        f"Modelo: {item.device_model or 'Não informado'}",
        ...
        f"Urgência: {item.urgency or 'Não informada'}",
        f"Impacto: {item.impact or 'Não informado'}",
